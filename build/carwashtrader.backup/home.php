...
if(substr($pageReferrer,0,4) != '' && substr($pageReferrer,0,4) != 'home')
        ...
        <article>
        	<?php
        		if(!is_user_logged_in()) {
        			...
        			echo '<p><br />For full access to classified listings: Car Wash for Sale, Suppliers, Jobs and ';
        			echo 'Advertising with us, <a href="/register/" title="Register">register here</a>.</p>';
        			echo '</div>';
        		}
        	?>
            	...
            	if(isset($_GET["showID"])) {
					...
					if(sizeof($results) > 0) {
						...
						for($r=$start; $r<$end; $r++) {
							...
							//Adverts
							if($r > 0 && ($r+1)<15 && (($r+1)%5) == 0 && sizeof($results) > $advertCount*5) {
								$advertCount++;
