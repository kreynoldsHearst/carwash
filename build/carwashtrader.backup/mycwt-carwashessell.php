...
if ( 'POST' == $_SERVER['REQUEST_METHOD'] && !empty( $_POST['action'] )) {
	...
	if (!empty ($_POST['sale_advert_title'])) 
		$advert_title =  htmlentities($_POST['sale_advert_title']); 
	else  $error[] = 'Please enter a title for the sale listing';

	if (!empty ($_POST['sale_listing_info'])) 
		$listing_info = htmlentities($_POST['sale_listing_info']); 
	...
	if (!empty ($_POST['sale_purchase_link'])) 
		$purchase_link =  htmlentities($_POST['sale_purchase_link']); 
	...
	$for_sale = htmlentities($_POST['sale_for_sale']);
	$business_size = htmlentities($_POST['sale_business_size']);
	$leasehold_freehold = htmlentities($_POST['sale_leasehold_freehold']);
	$leasehold_years = htmlentities($_POST['sale_leasehold_years']);
