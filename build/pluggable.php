...
function wp_mail( $to, $subject, $message, $headers = '', $attachments = array() ) {
	...
	//CWT Email Header and Footer
	$cwtEmailHeader = '<table style="width:100%;background:#cecece;font-family:arial;" cellpadding="0" cellspacing="0"><tr><td></td><td style="width:600px;"><table style="width:100%;background:#ffffff;" cellpadding="0" cellspacing="0"><tr style="background:#ccbcf3;"><td style="padding:20px;"><table width="100%"><tr><td><img src="http://www.carwashtrader.co.uk/wp-content/themes/carwashtrader/assets/images/carwash-trader-email-header.gif" alt="Car Wash Trader" /></td><td style="text-align:right;color:#ffffff;font-weight:bold;font-size:30px;">'.$subject.'</td></tr></table></td></tr><tr><td><table cellpadding="0" cellspacing="20" style="width:100%;"><tr><td>';
	$cwtEmailFooter = '</td></tr></table></td></tr><tr style="background:#ccbcf3;"><td style="padding:10px;"><table cellpadding="0" cellspacing="0" style="width:100%;"><tr><td style="color:#666666;">&nbsp;</td><td style="text-align:right;color:#666666;"><b>Email</b>: <a style="color:#666666;" href="mailto:info@carwashtrader.co.uk" title="Email Us">info@carwashtrader.co.uk</a></td></tr></table></td></tr></table></td><td></td></tr></table>';
	
	// Set mail's subject and body
	$phpmailer->Subject = $subject;
	$phpmailer->Body    = $cwtEmailHeader.$message.$cwtEmailFooter;
