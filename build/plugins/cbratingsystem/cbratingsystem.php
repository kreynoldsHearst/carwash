		...
		$form_criteria = array(
			...
			(
				...
				(
					...
					'stars' => array
					(
						'0' => array('enabled' => 1,'title' => __('Bad','cbratingsystem')),
						'1' => array('enabled' => 1,'title' => __('Poor','cbratingsystem')),
						'2' => array('enabled' => 1,'title' => __('Average','cbratingsystem')),
						'3' => array('enabled' => 1,'title' => __('Good','cbratingsystem')),
						'4' => array('enabled' => 1,'title' => __('Great','cbratingsystem'))
					)
