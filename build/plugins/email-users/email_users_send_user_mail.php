...
//error_log(print_r($_POST, true)) ;
    ...
    $from_name = 'Car Wash Trader'; //overwrite username as from address - setting doesnt work
	...
	<?php 
        ...
        //CWT custom email template
        $emailHeader = '<html style="padding:0px;margin:0px;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><title>Car Wash Trader Admin Message</title></head><body style="background:#cecece;padding:0px;margin:0px;"><table style="width:100%;font-family:arial;" cellpadding="0" cellspacing="0"><tr><td></td><td style="width:600px;"><table style="width:100%;background:#ffffff;" cellpadding="0" cellspacing="0"><tr style="background:#ccbcf3;"><td style="padding:20px;"><table width="100%"><tr><td><img src="http://www.carwashtrader.co.uk/wp-content/themes/carwashtrader/assets/images/carwash-trader-email-header.gif" alt="Car Wash Trader" /></td><td style="text-align:right;color:#ffffff;font-weight:bold;font-size:30px;">Admin Message</td></tr></table></td></tr><tr><td><table cellpadding="0" cellspacing="20" style="width:100%;"><tr><td>';
		$emailFooter = '</td></tr></table></td></tr><tr style="background:#ccbcf3;"><td style="padding:10px;"><table cellpadding="0" cellspacing="0" style="width:100%;"><tr><td style="color:#666666;"><b>Tel</b>: 0800 073 4540</td><td style="text-align:right;color:#666666;"><b>Email</b>: <a style="color:#666666;" href="mailto:info@carwashtrader.co.uk" title="Email Us">info@carwashtrader.co.uk</a></td></tr></table></td></tr></table></td><td></td></tr></table></body></html>';
	...
	<?php
			...
			$num_sent = mailusers_send_mail($recipients, $subject, $emailHeader.$mail_content.$emailFooter, $mail_format, $from_name, $from_address);
			if (false === $num_sent) {
